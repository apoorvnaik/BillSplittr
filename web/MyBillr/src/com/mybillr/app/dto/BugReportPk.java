...
/** 
 * This class represents the primary key of the bug_report table.
 */
public class BugReportPk implements Serializable
{
	protected int id;
	 ...
	 * @param id
	 */
	public BugReportPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof BugReportPk)) {
			return false;
		}
		
		final BugReportPk _cast = (BugReportPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.mybillr.app.dto.BugReportPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
