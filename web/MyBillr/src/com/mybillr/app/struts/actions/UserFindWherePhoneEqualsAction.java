...
public class UserFindWherePhoneEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			int _phone = Integer.parseInt( request.getParameter("phone") );
		
			// create the DAO class
			UserDao dao = UserDaoFactory.create();
		
			// execute the finder
			User dto[] = dao.findWherePhoneEquals(_phone);
