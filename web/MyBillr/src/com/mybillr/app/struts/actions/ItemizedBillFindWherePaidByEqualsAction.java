...
public class ItemizedBillFindWherePaidByEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _paidBy = request.getParameter("paidBy");
		
			// create the DAO class
			ItemizedBillDao dao = ItemizedBillDaoFactory.create();
		
			// execute the finder
			ItemizedBill dto[] = dao.findWherePaidByEquals(_paidBy);
