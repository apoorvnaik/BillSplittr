...
public class BugReportFindWhereMessageEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _message = request.getParameter("message");
		
			// create the DAO class
			BugReportDao dao = BugReportDaoFactory.create();
		
			// execute the finder
			BugReport dto[] = dao.findWhereMessageEquals(_message);
