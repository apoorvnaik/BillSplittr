...
public class LedgerFindWhereOwesToEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			int _owesTo = Integer.parseInt( request.getParameter("owesTo") );
		
			// create the DAO class
			LedgerDao dao = LedgerDaoFactory.create();
		
			// execute the finder
			Ledger dto[] = dao.findWhereOwesToEquals(_owesTo);
