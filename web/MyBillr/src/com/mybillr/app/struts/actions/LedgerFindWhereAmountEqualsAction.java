...
public class LedgerFindWhereAmountEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			int _amount = Integer.parseInt( request.getParameter("amount") );
		
			// create the DAO class
			LedgerDao dao = LedgerDaoFactory.create();
		
			// execute the finder
			Ledger dto[] = dao.findWhereAmountEquals(_amount);
