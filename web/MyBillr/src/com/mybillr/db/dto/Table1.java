...
{
	/** 
	 * This attribute maps to the column id in the table1 table.
	 */
	protected int id;
	...
	/** 
	 * This attribute maps to the column name in the table1 table.
	 */
	...
	/** 
	 * This attribute maps to the column symbol in the table1 table.
	 */
	...
	/** 
	 * This attribute maps to the column rate in the table1 table.
	 */
	protected long rate;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof Table1)) {
			return false;
		}
		
		final Table1 _cast = (Table1) _other;
		if (id != _cast.id) {
			return false;
		}
	 ...
	 * @return Table1Pk
	 */
	public Table1Pk createPk()
	{
		return new Table1Pk(id);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.mybillr.db.dto.Table1: " );
		ret.append( "id=" + id );
