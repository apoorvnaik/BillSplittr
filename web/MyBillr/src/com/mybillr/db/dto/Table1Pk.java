...
/** 
 * This class represents the primary key of the table1 table.
 */
public class Table1Pk implements Serializable
{
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof Table1Pk)) {
			return false;
		}
		
		final Table1Pk _cast = (Table1Pk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.mybillr.db.dto.Table1Pk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
