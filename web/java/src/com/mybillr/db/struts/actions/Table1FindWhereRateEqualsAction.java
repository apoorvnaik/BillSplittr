...
public class Table1FindWhereRateEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			long _rate = Long.parseLong( request.getParameter("rate") );
		
			// create the DAO class
			Table1Dao dao = Table1DaoFactory.create();
		
			// execute the finder
			Table1 dto[] = dao.findWhereRateEquals(_rate);
