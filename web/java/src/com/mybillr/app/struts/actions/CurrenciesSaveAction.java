...
public class CurrenciesSaveAction extends Action
{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			...
			dto.setId( Short.parseShort( currenciesForm.getId() ));
			dto.setCode( currenciesForm.getCode());
			dto.setCurrency( currenciesForm.getCurrency());
			dto.setCountry( currenciesForm.getCountry());
