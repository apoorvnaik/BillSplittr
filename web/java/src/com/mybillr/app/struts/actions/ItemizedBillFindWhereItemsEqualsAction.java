...
public class ItemizedBillFindWhereItemsEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _items = request.getParameter("items");
		
			// create the DAO class
			ItemizedBillDao dao = ItemizedBillDaoFactory.create();
		
			// execute the finder
			ItemizedBill dto[] = dao.findWhereItemsEquals(_items);
