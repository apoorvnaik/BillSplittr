...
public class ItemizedBillFindByPrimaryKeyAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			...
			// execute the finder
			ItemizedBill dto = dao.findByPrimaryKey(_id);
			...
			ItemizedBillForm itemizedBillForm = new ItemizedBillForm();
			itemizedBillForm.setCrudMethod( request.getParameter("crudMethod") );
			itemizedBillForm.setId(String.valueOf( dto.getId() ));
			itemizedBillForm.setPaidBy(dto.getPaidBy());
			itemizedBillForm.setItems(dto.getItems());
			// store the results
			request.getSession().setAttribute( "ItemizedBill", itemizedBillForm );
