...
public class EmailSentFindWhereSubjectEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			java.lang.String _subject = request.getParameter("subject");
		
			// create the DAO class
			EmailSentDao dao = EmailSentDaoFactory.create();
		
			// execute the finder
			EmailSent dto[] = dao.findWhereSubjectEquals(_subject);
