...
public class ItemsFindWherePriceEqualsAction extends Action
{
	/**
	 * Method 'execute'
	 * 
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		try {
			// parse parameters
			long _price = Long.parseLong( request.getParameter("price") );
		
			// create the DAO class
			ItemsDao dao = ItemsDaoFactory.create();
		
			// execute the finder
			Items dto[] = dao.findWherePriceEquals(_price);
