...
/** 
 * This class represents the primary key of the email_sent table.
 */
public class EmailSentPk implements Serializable
{
	protected int id;
	 ...
	 * @param id
	 */
	public EmailSentPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof EmailSentPk)) {
			return false;
		}
		
		final EmailSentPk _cast = (EmailSentPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.mybillr.app.dto.EmailSentPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
