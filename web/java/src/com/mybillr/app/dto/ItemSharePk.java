...
/** 
 * This class represents the primary key of the item_share table.
 */
public class ItemSharePk implements Serializable
{
	protected int id;
	 ...
	 * @param id
	 */
	public ItemSharePk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof ItemSharePk)) {
			return false;
		}
		
		final ItemSharePk _cast = (ItemSharePk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.mybillr.app.dto.ItemSharePk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
